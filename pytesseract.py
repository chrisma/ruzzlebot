...
def run_tesseract(input_filename, output_filename_base, lang=None, boxes=False, psm_level=None, configfile=None):
    '''
    runs the command:
    ...
    if psm_level is not None:
        command += ['-psm', psm_level]
...
def image_to_string(image, lang=None, boxes=False, psm_level=None, configfile=None):
    '''
